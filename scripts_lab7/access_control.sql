...
CREATE USER serj FOR LOGIN serj with default_schema = dbo;  /*дает пользователю возможность видеть собственное имя пользователя, пользователей системы 
и предопределенные роли базы данных (задаются на уровне базы данных и предусмотрены в каждой бд)*/
